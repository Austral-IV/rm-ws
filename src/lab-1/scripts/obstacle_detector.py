...
class ObstacleDetector(object):
  """ Detector de obstáculos. Revisa si hay algo muy cerca del robot. Puede 
  cambiarse la distancia aceptable y resolución del detector.
  Publica a obstacle_spotter "free" si está libre o dónde hay obstáculos en otro caso."""
